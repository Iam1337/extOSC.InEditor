...
namespace extEditorOSC.Panels
{
	public class OSCPanelComponents : OSCPanel
	{
		...
		private class Group
		{
			...
			public List<OSCEditorComponent> ReceiverComponents = new List<OSCEditorComponent>();

			public List<OSCEditorComponent> TransmitterComponents = new List<OSCEditorComponent>();
		...
		{
			return EditorOSCPopup(OSCEditorUtils.GetReceivers(), receiver, content);
		}
